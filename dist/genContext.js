...
defaultValue) {
    if (ProviderWrapper === void 0) { ProviderWrapper = _1.SimpleProviderWrapper; }
    ...
    var DoneProvider = function (_a) {
        var children = _a.children, _b = _a.value, value = _b === void 0 ? defaultValue : _b, props = __rest(_a, ["children", "value"]);
        return (react_1.default.createElement(ProviderWrapper, __assign({}, props, { value: value, RealProvider: Context.Provider }), children));
    };
